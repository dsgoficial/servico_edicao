...
* Integração com [QGIS 4](https://www.qgis.org/) via [DSGTools](https://github.com/dsgoficial/DsgTools) e com o [Sistema de Apoio a Produção](https://github.com/1cgeo/sap)
