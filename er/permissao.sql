  ...
  GRANT USAGE ON SCHEMA edicao TO $1:name;
  GRANT SELECT, INSERT, UPDATE, DELETE ON ALL TABLES IN SCHEMA edicao TO $1:name;
  GRANT USAGE, SELECT ON ALL SEQUENCES IN SCHEMA edicao TO $1:name;
